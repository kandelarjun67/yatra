  ...
  <div className="container mx-auto flex px-5 py-7 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Platform for online cab 
        <br className="hidden lg:inline-block"/>with Yatra
      </h1>
      <p className="mb-8 leading-relaxed">
      Get to your destination safely and on time with Yatra.
      </p>
      <div className="flex justify-center">
        <button className="inline-flex text-white bg-indigo-400 border-0 py-3 px-6 focus:outline-none hover:bg-indigo-600  text-lg">Passenger</button>
        <button className="inline-flex text-white bg-indigo-300 border-0 py-3 px-6 focus:outline-none hover:bg-indigo-600  text-lg"> Rider </button>
